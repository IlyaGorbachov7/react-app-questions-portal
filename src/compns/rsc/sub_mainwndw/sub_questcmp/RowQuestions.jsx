...
const RowQuestions = ({q, deleteCallback, updateCallback, ...props}) => {
        ...
        <tr {...props}>
            ...
            <td width={"8%"}>
                <div className="d-flex justify-content-end">
                    <button className="btn-sm btn btn-outline-dark" onClick={editQuest}>
                    ...
                    <button className="ms-1 btn-sm btn btn-outline-danger" onClick={deleteQuest }>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
