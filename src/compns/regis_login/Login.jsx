...
const Login = () => {
    return (
        <div className="centerXY d-flex flex-column align-items-center block-color">
            ...
            <p className="mt-2">Don't have account? <a href="/registration" className="color-text-type font-weight-600">Sing Up</a></p>
        </div>
    );
};
